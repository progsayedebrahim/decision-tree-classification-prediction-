...
public class readjsondata {
    ...
    public static void main(String[] args) throws AnalysisException {
        ...
        data.show();
        Dataset<Row> m = data.select("humidity", "outlook");
         m.show();
         data.createTempView("section");
       Dataset<Row> mm = session.sql("select humidity from section");
        mm.show();
       // select specific coulmns using select method 
        ...
        // using  logistic regression from spark ML
